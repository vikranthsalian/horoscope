...
class BhavaSandhiScreen extends StatelessWidget {
  final double lagnaValue, dasamaValue;
  BhavaSandhiScreen({required this.lagnaValue, required this.dasamaValue});

  List<BhavaSandhiModel> list = [];
  List<String> headers = ["bhava", "madhya", "anthya"];
